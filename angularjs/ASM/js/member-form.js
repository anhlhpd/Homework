		...
		xhr.onreadystatechange = function() {		
			if(this.readyState === XMLHttpRequest.DONE) {
				...
				if(this.status === 200){
					...
					var htmlContent = "";
					htmlContent += '<ul class="nav navbar-nav navbar-right out">'
				    htmlContent +=	'<li><a href="#"><span class="glyphicon glyphicon-log-in"></span> Sign Up</a></li>'
				    htmlContent +=	'<li><a href="#"><span class="glyphicon glyphicon-log-in"></span> Đăng xuất</a></li>'
				    htmlContent +=	'</ul>'
					$(".in").html(htmlContent);
				} else {
